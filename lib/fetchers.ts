...
export const getStravaStats = unstable_cache(
  async (): Promise<StravaStats | null> => {
    console.log(">>> STRAVA CACHE MISS: Fetching from API...");
...
export const getLeetCodeStats = unstable_cache(
  async (): Promise<LeetCodeStats | null> => {
    console.log(">>> LEETCODE CACHE MISS: Fetching from API...");
...
// 3. DUOLINGO
export const getDuolingoStats = unstable_cache(
  async (): Promise<DuolingoStats | null> => {
    console.log(">>> DUOLINGO CACHE MISS: Fetching from API...");
